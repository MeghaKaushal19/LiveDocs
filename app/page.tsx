...
const page = () => {
  return (
    <div className = "flex flex-col items-center justify-center py-2">
      ...
      <button className="border border-solid border-black rounded-xl shadow-lg py-2 px-20 flex flex-col items-center justify-center">   
      <Image src="/images/image 7.png" alt="LiveDocs" width={20} height={20} />
        Live Docs
        </button>
      <button className="border border-solid border-black rounded-xl shadow-lg py-2 px-20 flex flex-col items-center justify-center">
      <Image src="/images/image 5.png" alt="LiveSync" width={20} height={20} />
        Live Sync
        </button>
      </div>  
